...
export const supplements: Supplement[] = [
  {
    ...
    links: [{ url: "https://www.muscle-zone.pl/p/melatonin-200-tab-p-8547" }],
  },
  {
    name: "Glicyna",
  ...
  },
  {
    ...
    links: [{ url: "https://www.muscle-zone.pl/aminokwasy/l-tryptophan-250g" }],
  },
  {
    name: "GABA",
    dosage: "1000mg przed spaniem",
    links: [{ url: "https://www.muscle-zone.pl/lepszy-sen/gaba-powder-250g" }],
  ...
  },
  {
    ...
    links: [{ url: "https://www.muscle-zone.pl/tauryna/taurine-250-g" }],
  },
  {
    name: "Spermidyna",
    dosage: "1 kaps. przed spaniem",
  ...
  },
  {
    name: "Hupercyna A",
    dosage: "1 kaps. przed spaniem",
    links: [{ url: "https://www.muscle-zone.pl/cholina/huperzine-a-120-kaps" }],
  },
  {
    name: "Alpha GPC",
    dosage: "1 kaps. przed spaniem",
    links: [{ url: "https://www.muscle-zone.pl/p/cdp-choline-90-kaps-p-6768" }],
    warning: "Może zaburzać zasypianie!",
  },
  {
    name: "Apigenina",
    dosage: "50 mg przed spaniem",
    links: [{ url: "https://www.muscle-zone.pl/p/apigenin-60-kaps-p-8788" }],
    warning: "Możliwe interakcje z lekami przeciwzakrzepowymi i sedatywnymi",
  },
  {
    name: "Inozytol",
    ...
    links: [
      {
        url: "https://swiatsupli.pl/witaminy-b-now-foods-inositol-500mg-100kaps/p4656",
      },
    ],
  },
  {
    ...
    links: [
      {
        label: "Amino Up ETAS",
        url: "https://enaturalnie.pl/etas-wyciag-z-lodyg-szparaga-lekarskiego-wsparcie-ukladu-nerwowego-60-kaps-amino-up_4909.html",
      },
      {
        label: "Swanson Asparagus Extract",
        url: "https://swiatsupli.pl/antyoksydanty-ekstrakt-ze-szparagow-swanson-asparagus-extract-60kaps/p6095",
      },
    ],
  },
];
...
export const effectCategories: EffectCategory[] = [
  {
    ...
    items: [
      ...
      { supplement: "ETAS", effect: "↑ 5 - 10%" },
      { supplement: "Apigenina", effect: "↑ 5 - 10%" },
      { supplement: "Inozytol", effect: "↑ 5 - 10%" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { supplement: "Glicyna", effect: "↓ 10 - 20%" },
      { supplement: "ETAS", effect: "↓ 5 - 15%" },
    ],
  },
  {
...
export const bibliography: string[] = [
  ...
  'Avallone, S. et al. (2000). "Apigenin, a component of Matricaria recutita flowers, is a central benzodiazepine receptors-ligand with anxiolytic effects". Pharmacol Biochem Behav, 65(3), 479 - 484.',
  'Mousavi, S. M. et al. (2024). "Effects of chamomile (Matricaria chamomilla L.) on sleep: A systematic review and meta-analysis of clinical trials". Complement Ther Med, 79, 102987.',
  'Celik, C. et al. (2020). "The impact of myo-inositol supplementation on sleep quality in pregnant women: a randomized, double-blind, placebo-controlled study". J Matern Fetal Neonatal Med, 33(18), 3175 - 3181.',
  'Takanari, J. et al. (2016). "Effect of Enzyme-Treated Asparagus Extract (ETAS) on Psychological Stress in Healthy Individuals". J Nutr Sci Vitaminol, 62(3), 198 - 205.',
];
