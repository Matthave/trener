...
export const insomniaStory = {
  ...
  lead:
    "Osobista historia o bezsenności, lęku, przeciążeniu i powolnym wracaniu do snu.",
  blocks: [
    {
      type: "text",
      paragraphs: [
