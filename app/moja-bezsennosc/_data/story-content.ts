  ...
  blocks: [
    {
      ...
      paragraphs: [
        ...
        `Ironicznie, u mnie zaczęło się od przeczytania książki "Dlaczego śpimy?" Matthew Walkera. Sięgnąłem po nią z czystego zainteresowania snem, ponieważ jest to jeden z filarów zdrowego trybu życia, którym od zawsze się pasjonuję. Miałem nadzieję poznać dokładniej mechanizmy zarządzające snem i może znaleźć sposoby na zoptymalizowanie własnego, który do tej pory był bardzo dobry. Nigdy przedtem, na żadnym etapie życia, nie miałem większych problemów z zasypianiem ani wybudzeniami. W dalszej przeszłości zdarzały się jedynie sytuacje w stylu „spojrzenie na zegarek i przekręcenie się na drugi bok”. Parę dni po lekturze pierwszy raz wybudziłem się około 6 nad ranem i nie potrafiłem ponownie zasnąć. Jako osoba dobrze znająca swoje ciało, od razu odnotowałem to w głowie pod hasłem: „O co chodzi?”. Kolejną noc przespałem od zaśnięcia do budzika, więc uspokoiłem się, że to jednorazowe zdarzenie. Jednak już następnej nocy sytuacja się powtórzyła - z tą różnicą, że obudziłem się o 3 i tak samo jak poprzednio nie mogłem zasnąć. Mimo że był to dopiero drugi raz, czerwona lampka w mojej głowie eksplodowała.`,
        `Choć do stanu, który przechodziłem później, było jeszcze daleko, na tamtą chwilę czułem, że ewidentnie coś jest nie tak. Niepokoił mnie również sam sposób wybudzania - najbardziej przypominało to uczucie nagłego „wynurzania się” ze snu. Zawsze działo się to w trakcie fazy marzeń sennych, podczas których wręcz czułem, że tracę ten sen, aż w końcu przechodziłem w stan stuprocentowego rozbudzenia, po którym nie potrafiłem już zasnąć. Sytuacja powtarzała się w kolejnych nocach. Gdy się wybudzałem, zostawałem w łóżku i starałem się usnąć, zazwyczaj zajmowało mi to ok. 2-3 godziny, więc pozostawało mi niewiele prawdziwego snu.`,
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `Po trzeciej nieprzespanej nocy zapisałem się do psychiatry „na już”. Był weekend, więc musiałem zdecydować się na konsultację online. Znalazłem specjalistę od zaburzeń snu i lęków. Wartość terapeutyczna tej wizyty była żadna, co mocno mnie uderzyło, bo był to mój pierwszy kontakt z psychiatrią. Dowiedziałem się, że 1/3 tabletki Trittico to za mało i mam brać całą, a dodatkowo przepisano mi Egzystę. Trittico miało pomóc zasnąć i utrzymać sen, a Egzysta działać przeciwlękowo. Wejście w tematy psychologiczne rzuciło nowe podejrzenia: czy problemy ze snem nie są spowodowane początkami zaburzeń lękowych lub depresji? Nie umiałem tego ustalić. Czy to ukryte lęki wywołały bezsenność, czy bezsenność była wczesnym zwiastunem nadciągających lęków? Co było pierwsze? Ogromnie mnie to męczyło, frustrowało i martwiło, że nie potrafię określić przyczyny. Nie mogłem wręcz uwierzyć, że praktycznie z dnia na dzień znalazłem się w takiej sytuacji - przecież jeszcze przed chwilą wszystko było w porządku.`,
      ],
    },
    {
      type: "tile",
      ...
      paragraphs: [
        `W momencie gdzie jeszcze szamotałem się bez konkretnego pomysłu i kierunku, co jakiś czas wpadałem na strzęp informacji dotyczące rozregulowanego układu nerwowego. Według mnie przyczyna musiała być organiczna i namacalna, więc szybko natrafiłem na pojęcie Overtraining syndrome - OTS (Zespół przetrenowania). Jest to stan skrajnego wyczerpania organizmu wywołany zbyt intensywnymi treningami przy niewystarczającej regeneracji, mogą być jego różne nasilenia, a jednym z jego objawów jest bezsenność, a nawet lęki i depresja. Był to powód dlaczego zdecydowałem sę na zredukowanie jednostek treningowych.`,
      ],
    },
    {
      type: "text",
      paragraphs: [
        ...
        `Zacząłem mieć nocne ataki paniki tuż po wybudzeniu. Zrywałem się z łóżka, by przekierować uwagę na coś innego, chciałem też stosować się do zasad CBT-I snu, czyli stosować zasadę ograniczenia czuwania w łóżku. Zaliczyłem kolejne dwie nieprzespane noce. Gdy było ze mną źle, znowu zwróciłem się do psychiatry. Po krótkim opisie sytuacji i przyznaniu, że byłem bliski wezwania karetki (mimo że zdawałem sobie sprawę z absurdu tego pomysłu), lekarz przepisał mi lek z grupy SSRI, który miała zadziałać na obsesyjne myśli. Wycofaliśmy Trittico, a w jego miejsce jako środek ułatwiający sen dostałem Ketrel. Egzysta pozostała bez zmian.`,
        `Tuż po wzięciu Ketrelu odczucia były bardzo podobne jak przy Trittico: poczucie ciężkości i tężejąca twarz. Brakowało mi tej przyjemnej, naturalnej senności. Obawiałem się, że to nic nie da, bo po etykiecie „środka nasennego” (mimo że Ketrel typowym lekiem nasennym nie jest) oczekuje się po prostu spania. Mimo wszystko w jakiś sposób wyciszał on mój układ nerwowy, bo ostatecznie udawało mi się usnąć, mimo że miałem wrażenie że do tego jeszcze daleko. Nadal zasypiałem po 1-2 godzinach i wciąż się wybudzałem, ale miało to miejsce później (np. po 4-5 godzinach, a nie po 2) i łatwiej mi było ponownie zasnąć.`,
      ],
    },
    {
      type: "tile",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `Myślałem wtedy o innych, którzy mają problemy ze snem, patrzyłem czasem za okno w poszukiwaniu czy ktoś nie idzie przez ulice albo gdzieś nie pali się światło. Czasem wybiegałem myślą na drugą stronę świata i myślałem że gdzieś już jest rano i wszyscy są już na nogach, dopiero szykują się do rozpoczęcia dnia.`,
      ],
    },
    {
      type: "text",
    ...
    },
    {
      type: "text",
      paragraphs: [
        `Na początku stycznia, wciąż trzymając się wypracowanych metod, próbowałem zejść z ostatniej dawki Egzysty. Zrobiłem to chyba zbyt szybko, bo pojawił się silny efekt odstawienny i mocne pogorszenie jakości snu. Znowu zacząłem wybudzać się w środku nocy (po 3,5-4,5 godzinach snu) i nie potrafiłem ponownie zasnąć. Wróciłem do przed chwilą odstawionej dawki i po konsultacji z terapeutką, zacząłem stosować jedną z zasad CBT-I: wychodzenie z łóżka. Gdy nie udawało mi się zasnąć przez ok. 15-20 minut, wstawałem, by zająć się czymś nudnym przy słabym świetle - czytałem książkę, układałem puzzle, słuchałem spokojnej muzyki lub podcastu. Miałem też wyznaczone restrykcyjne „okno snu”, niezależnie od tego jak spałem, zaczynałem dzień zawsze o tej samej porze. Metoda wychodzenia z łóżka trwała u mnie 1-2 tygodnie, mój sen przypominał sen dwufazowy. Nigdy nie odsypiałem w ciągu dnia. Zresztą miałem wrażenie, że w ogóle straciłem umiejętność drzemania, co mnie martwiło, bo wydawało mi się, że po nieprzespanej nocy powinienem być ekstremalnie senny - a nie byłem.`,
      ],
    },
    {
      type: "tile",
    ...
    },
    {
      type: "text",
      paragraphs: [
        `Wraz z partnerką, zaplanowaliśmy tygodniowe wakacje. Dla mnie to był ogromny krok. Obawiałem się lotu, obcego miejsca i zburzenia moich misternie wypracowanych rytuałów. Zaliczyłem tąpnięcie już pierwszej nocy przed wylotem - pierwszy raz od wielu tygodni, zasypiałem przez 2 godziny. Dla człowieka niemającego problemów ze snem to nic nadzwyczajnego - zdarza się, dla mnie była to prawdziwa tragedia. Gdy wylądowaliśmy, znów wezbrały lęki, w tym dziwna odmiana lęku separacyjnego (wywołane pobytem za granicą). Uruchomiłem jednak autoterapię, racjonalizując wszystko i przypominając sobie zdobytą wiedzę. Zastosowałem wyuczone techniki, uspokoiłem głowę. W efekcie, pierwszej nocy na wyjeździe zasnąłem po 15 minutach. Przebudziłem się, jak zawsze, ale było to jedno, krótkie przebudzenie na przewrócenie się na drugi bok. Wstałem z doskonałym humorem. Wakacyjny sen okazał się ostatecznie rewelacyjnej jakości - lepszy niż nawet najlepsze noce sprzed wyjazdu. Podczas pobytu nie miałem ani jednej gorszej nocy.`,
      ],
    },
    {
      type: "tile",
